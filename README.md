...
O objetivo do programa é criptografar e descriptografar mensagens  usando a Cifra de Cesar, um tipo de cifra por substituição, em que uma letra no texto original é substituída por outra, seguindo um número fixo para essa subtituição. 
...
![Diagrama de Blocos](images\diagrama.png)
